  ...
  public: {
    Tables: {
      ...
      client_recommendations: {
        ...
        Relationships: [
          {
            foreignKeyName: "client_recommendations_recommendation_system_id_fkey"
            columns: ["recommendation_system_id"]
            isOneToOne: false
            referencedRelation: "recommendation_systems"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "client_recommendations_workspace_id_fkey"
            columns: ["workspace_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
